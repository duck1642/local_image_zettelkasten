      ...
      <div class="overlay-workspace">
        ...
        <div class="overlay-pane">
          ...
          <div class="pane-meta">
            ...
            {/if}
            {#if stagedFrames > 1}
              <div class="meta-row"><span class="meta-label">Frame Count:</span> <span class="meta-val">{stagedFrames} frames</span></div>
            {/if}
            {#if isVideoMedia(current)}
              {#if stagedDuration > 0}
                <div class="meta-row"><span class="meta-label">Duration:</span> <span class="meta-val">{formatDuration(stagedDuration)}</span></div>
              {/if}
              {#if stagedCodec}
                <div class="meta-row"><span class="meta-label">Video Codec:</span> <span class="meta-val uppercase">{stagedCodec}</span></div>
              {/if}
              <div class="meta-row"><span class="meta-label">Audio Track:</span> <span class="meta-val">{current.metadata?.audio_present ? 'AAC Stereo' : 'Silent'}</span></div>
            {/if}
        ...
        <div class="overlay-pane">
          ...
          <div class="pane-meta">
            {#if activeMatch}
              ...
              {/if}
              {#if vaultFrames > 1}
                <div class="meta-row"><span class="meta-label">Frame Count:</span> <span class="meta-val">{vaultFrames} frames</span></div>
              {/if}
              {#if isVideoMedia(activeMatch)}
                {#if vaultDuration > 0}
                  <div class="meta-row"><span class="meta-label">Duration:</span> <span class="meta-val">{formatDuration(vaultDuration)}</span></div>
                {/if}
                {#if vaultCodec}
                  <div class="meta-row"><span class="meta-label">Video Codec:</span> <span class="meta-val uppercase">{vaultCodec}</span></div>
                {/if}
                <div class="meta-row"><span class="meta-label">Audio Track:</span> <span class="meta-val">{activeMatch.audio_present ? 'AAC Stereo' : 'Silent'}</span></div>
              {/if}

...
- Split logs into raw console output and structured JSONL streams.
...
- Added Settings vault tools for create-merged-vault preview/create, vault health audit/repair details, backup/restore/export/import packages, create/rename/delete, and active vault selection.
